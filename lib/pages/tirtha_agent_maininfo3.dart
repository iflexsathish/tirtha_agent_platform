...
class tirthaAgentMainInfo3 extends StatefulWidget {
  @override
  _tirthaAgentMainInfo3State createState() => _tirthaAgentMainInfo3State();
}

class _tirthaAgentMainInfo3State extends State<tirthaAgentMainInfo3> {
